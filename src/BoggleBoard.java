/*************************************************************************
 * Compilation: javac BoggleBoard.java Execution: java BoggleBoard Dependencies: StdRandom.java In.java StdOut.java
 * 
...
public class BoggleBoard {
     ...
     * 
     * @param filename
     *            the name of the file containing the Boggle board
     */
     ...
     * @param j
     *            the column
     * @return the letter in row i and column j with 'Q' representing the two-letter sequence "Qu".
     */
